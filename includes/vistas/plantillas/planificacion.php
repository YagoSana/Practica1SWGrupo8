    ...
    <div id="contenedor">
        ...
        <main>
            <article>
                <section>
                    <h2>PLANIFICACIÓN</h2>
                    <p>A continuación, se expone cómo estará planificado el proyecto, separado en las distintas tareas a
                        realizar y la fecha límite de entrega de cada una. El trabajo de dichas tareas será repartido
                        entre todos los integrantes del grupo de manera equitativa. Para ver el diagrama de Gantt de las
                        diferentes tareas y sus fechas de realización, pulse <a href="#ap6">aquí</a>.</p>
                    <table>
                    ...
                    <ul>
                        ...
                        <li><strong>bocetos.html:</strong> bocetos de la página web dibujados en papel y explicaciones.
                        </li>
                    ...
                    <p>Esta práctica constará del diseño y arquitectura de nuestra aplicación web. Una primera versión
                        simple del proyecto.</p>
                    <h2 id="ap4">Práctica 3: Diseño de la apariencia.</h2>
                    <p>Ampliación del proyecto. Diseño de la apariencia de la aplicación usando hojas de estilos sobre
                        la entrega anterior e incrementando su funcionalidad. A esta altura estará realizado el entre el
                        40-50% del proyecto total.</p>
                    ...
                    <img src="<?php echo RUTA_IMGS . '/gantt.jpg' ?>" alt="Diagrama de gantt" width="1000px">
                </section>
            </article>
        </main>
