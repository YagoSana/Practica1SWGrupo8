...
$ruta = RUTA_SRC;
$titulo = 'Detalles de Back Music';
$contenido = <<<EOS
        <article>
            <section>
                <h2>¡Bienvenidos a nuestra revolucionaria tienda online de artículos de música!</h2>
                <p>
                    Nuestra plataforma es un paraíso para los amantes de la música, ofreciendo una experiencia única
                    de <strong>compra, venta y alquiler</strong> de instrumentos musicales y plataformas de
            ...
            <section>
                ...
                <p>
                    Nuestro objetivo es proporcionar una plataforma eficiente y fácil de usar que satisfaga todas
                    tus necesidades de comercio electrónico.
            ...
            <p>
                En resumen, nuestra plataforma es más que una simple tienda online. Es un espacio dónde la música
                cobra vida, donde puedes explorar, descubrir y experimentar la música de una manera completamente
                nueva.
            </p>
