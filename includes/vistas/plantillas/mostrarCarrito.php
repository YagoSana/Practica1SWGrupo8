    ...
    <div id="contenedor">
        ...
        <main>
            ...
            if (isset($_SESSION['login'])) {
                ...
                $carrito = $_SESSION['usuCompleto']->getCarrito(); //!!!!!Hay que cambiar esto a user no puede ser el la busqueda por el nombre¡¡¡¡¡¡ Tiene que devolver un objeto de tipo usuario
